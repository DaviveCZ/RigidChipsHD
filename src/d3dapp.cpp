...
INT CD3DApplication::Run()
{
    ...
    while( WM_QUIT != msg.message  )
    {
        ...
        else
        {
        	...
        	static float micro_t_I=0;//ϲ�ەb�̐ϕ��l
			float limitFps_micro_t=0;//m_dLimidFPS�̐؂�̂ĕ�
        	if(m_dLimidFPS==(1000L/60L)) limitFps_micro_t=1000.0f/60.0f-m_dLimidFPS;//�ق�Ƃ�m_dLimidFPS��float�Œ�`�������Ă��ׂ������ǂ߂�ǂ��������
        	else if(m_dLimidFPS==(1000L/30L)) limitFps_micro_t=1000.0f/30.0f-m_dLimidFPS;//�̂ł�����m_dLimidFPS����؂�̂ĕ�����
        	else if(m_dLimidFPS==(1000L/15L)) limitFps_micro_t=1000.0f/15.0f-m_dLimidFPS;//��Ηǂ��Ȃ������������ǂǁ[��15,30,60FPS�����g��Ȃ��ł��奥�
			DWORD t=timeGetTime();
